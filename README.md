...
| Sleeper Agent | [`health-apps/sleep-noise`](health-apps/sleep-noise) | Private browser-generated sleep noise with timers, fades and blackout mode, a space slider from mono through stereo to a binaural render that fills the room, plus five slow ambient synth themes for meditation. |
