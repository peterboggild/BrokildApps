...
{ "BENEATH THIRTY KILOMETRES OF CONCRETE", "DRONE",
  ...
  "st_on=1 st_gain=0.45 st_model=0 st_exc=3 st_exclvl=0.6 st_damp=0.2 st_dens=0.9 st_material=0.75 st_pitch=0.68 st_stiff=0.3 st_couple=0.15 st_send=0.5 st_hp=0.35\n"
...
{ "THE SEA IS MADE OF IRON", "DRONE",
  ...
  "st_on=1 st_gain=0.55 st_model=0 st_exc=2 st_exclvl=0.6 st_sustain=0.7 st_bowforce=0.55 st_bowvel=0.4 st_damp=0.3 st_dens=0.8 st_material=0.8 st_stiff=0.25 st_pitch=0.58 st_couple=0.25 st_send=0.6 st_loop=0.2 st_width=0.9\n"
...
{ "IRON BASS", "PLAYABLE BASS",
  ...
  "st_on=1 st_gain=0.5 st_model=1 st_exc=3 st_exclvl=0.5 st_damp=0.55 st_material=0.8 st_stiff=0.15 st_pitch=0.5 st_strikelvl=0.8 st_rel=0.5 st_send=0.15\n"
...
{ "CABLE BASS", "PLAYABLE BASS",
  ...
  "st_on=1 st_gain=0.5 st_model=1 st_exc=2 st_exclvl=0.5 st_sustain=0.6 st_bowforce=0.5 st_bowvel=0.35 st_damp=0.4 st_material=0.7 st_stiff=0.1 st_pitch=0.5 st_atk=0.4 st_rel=0.6 st_send=0.25\n"
...
{ "STEEL CATHEDRAL", "DRONE",
  ...
  "outtrim=0.4995 drone_root=36 drone_chord=2 m_on=0 st_on=1 st_gain=0.55 st_model=0 st_exc=2 st_exclvl=0.55 st_sustain=0.65 st_bowforce=0.5 st_bowvel=0.3 st_damp=0.2 st_dens=1.0 st_material=0.8 st_stiff=0.2 st_pitch=0.55 st_couple=0.3 st_send=0.7 st_width=1.0\n"
...
{ "STRESSED PLATE", "RESONANT GESTURE",
  ...
  "outtrim=0.5021 vmode=0 m_on=0 st_on=1 st_gain=0.55 st_model=0 st_exc=0 st_damp=0.3 st_dens=0.8 st_material=0.7 st_pitch=0.5 st_stress=0.4 st_couple=0.3 st_drive=0.3 st_strikelvl=0.9 st_rel=0.8 st_send=0.3\n"
...
{ "GLASS RAIN", "RESONANT GESTURE",
  ...
  "outtrim=0.8898 drone_root=60 drone_chord=7 m_on=0 st_on=1 st_gain=0.45 st_model=4 st_exc=1 st_exclvl=0.3 st_sustain=0.15 st_damp=0.2 st_dens=0.7 st_material=0.85 st_pitch=0.6 st_strikelvl=0.5 st_send=0.7 st_width=1.0\n"
...
{ "PLATE TECTONICS", "RESONANT GESTURE",
  ...
  "outtrim=0.4905 drone_root=33 drone_chord=0 m_on=0 st_on=1 st_gain=0.55 st_model=0 st_exc=2 st_exclvl=0.6 st_sustain=0.8 st_bowforce=0.7 st_bowvel=0.2 st_damp=0.25 st_dens=0.9 st_material=0.6 st_stiff=0.35 st_pitch=0.5 st_couple=0.35 st_drive=0.2 st_stress=0.5 st_send=0.5 st_width=0.9\n"
