...
param(
  [string]$Html = "C:\Users\peter\b\BattlestarOverdrive\docs\manual\manual.html",
  [string]$Dest = "C:\Users\peter\b\BattlestarOverdrive\docs\manual\pages",
  [int]$Port = 9301
)
...
& node "C:\Users\peter\b\BattlestarOverdrive\tools\cdp.js" $Port $jobsFile
