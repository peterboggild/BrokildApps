...
const SHEET = path.resolve(process.argv[3] || "sheet.png");
const at = (process.argv[4] || "0.2,1.0,2.0,3.0,3.8").split(",").map(Number);
...
try {
  const out = cp.execFileSync("node", [path.join(__dirname, "..", "tools", "cdp.js"), String(port), jobs], { encoding: "utf8", timeout: 120000, maxBuffer: 256 * 1024 * 1024 });
