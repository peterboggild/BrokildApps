...
$apps = @(
    @{ n = 'Photo-Synth2'; p = '$PSScriptRoot\..\build\PhotoSynth_artefacts\Release\Standalone\Photo-Synth2.exe' },
    @{ n = 'Escape Room';  p = '$PSScriptRoot\..\build\EscapeRoom_artefacts\Release\Standalone\Escape Room.exe' },
    @{ n = 'Mars Wars';    p = '$PSScriptRoot\..\build\MarsWars_artefacts\Release\Standalone\The Mars Wars.exe' },
    @{ n = 'Blade Ruiner'; p = '$PSScriptRoot\..\build\BladeRuiner_artefacts\Release\Standalone\Blade Ruiner.exe' }
)
