...
(function () {
  ...
  var DEFAULT_DESC = [
    ...
    { id: "kieranator", name: "KIERANATOR", sub: "step-sequenced havoc", ver: 1, custom: "steps", params: [
      ...
      { id: "last", name: "LAST", def: 16, lo: 2, hi: 32, step: 1, unit: "" },
      { id: "chaos", name: "CHAOS", def: 0, lo: 0, hi: 100, step: 0, unit: "%" }
    ] }
  ];
  ...
  var DEFAULT_CDESC = [
    { id: "darkdrone", name: "DARK DRONE", sub: "a cluster gone dark, drifting in colour", ver: 1, audio: 0, params: [
      { id: "cluster", name: "CLUSTER", def: 24, lo: 0, hi: 60, step: 0, unit: "¢" },
      { id: "sag", name: "SAG", def: 0, lo: 0, hi: 100, step: 0, unit: "%" },
  ...
  var DEFAULT_PRESETS = [
    { name: "VELVET STAGE", blob: {"modules":{"chorus":{"on":1,"p":{"mix":30,"depth":45}},"reverb":{"on":1,"p":{"mix":20,"character":1,"length":220}}}}, params: [] },
    { name: "DUB TELEGRAPH", blob: {"modules":{"delay":{"on":1,"p":{"mix":30,"time":340,"feedback":55,"character":1}},"lofi":{"on":1,"p":{"crush":20,"dirt":40}}}}, params: [] },
    { name: "MOTOR CITY", blob: {"modules":{"saturation":{"on":1,"p":{"drive":10,"tone":60}},"rotary":{"on":1,"p":{"speed":0,"mix":100,"growl":30}}}}, params: [] },
    { name: "CATHEDRAL BLOOM", blob: {"modules":{"shimmer":{"on":1,"p":{"mix":35,"size":70,"decay":70,"shimmer":55}}},"spectra":{"glass":{"on":1,"p":{"halo":70,"shine":50}}}}, params: [] },
    { name: "PINK HAZE", blob: {"spectra":{"pink":{"on":1,"p":{"swirl":60,"smear":60,"bloom":55}}}}, params: [] },
    { name: "IRON WORKS", blob: {"modules":{"strip":{"on":1,"p":{"amount":45}}},"spectra":{"black":{"on":1,"p":{"grind":70,"chop":60,"clang":45}}}}, params: [] },
    { name: "SEANCE", blob: {"modules":{"reverb":{"on":1,"p":{"mix":22,"character":3,"length":300}}},"spectra":{"tape":{"on":1,"p":{"wobble":60,"sag":0,"dull":55}}}}, params: [] },
    { name: "THE SWARM", blob: {"spectra":{"insect":{"on":1,"p":{"swarm":70,"flutter":65,"skitter":50}},"darkdrone":{"on":1,"p":{"cluster":30,"sag":0,"drift":50,"dtime":60}}}}, params: [] },
    { name: "BROKEN TRANSMISSION", blob: {"modules":{"kieranator":{"on":1,"x":"1000300010002060","p":{"mix":100,"crush":55}},"lofi":{"on":1,"p":{"crush":45,"dirt":35}}}}, params: [] },
  ...
  /* The step-grid editor (custom: "steps") — 16 cells, 8 effect brushes.
     ...
     screens of 16; LAST says where the loop actually ends. */
  var STEPFX = [
  ...
  var CSS = [
    ...
    ".bwfx-machint.armed{color:var(--bwfx-acc)}",
  ...
  function build() {
    ...
    veil.innerHTML =
      ...
      '  <div class="bwfx-machint" id="bwfxMacHint"></div>' +
  ...
  function renderList() {
    ...
    state.order.forEach(function (id, idx) {
      ...
      if (d.custom === "steps") (function () {
        ...
        hint.textContent = "PICK A BRUSH · PAINT · SAME BRUSH CLEARS · ?? DRAWS A DIFFERENT ONE EACH TIME";
